...
export default function Error({ message }: ErrorProps) {
    return <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-full no-blur z-20 my-2">
        <SimpleErrorNotification message={message} />
    </div>
}
...
const SimpleErrorNotification = ({ message, duration = 25000 }: SimpleErrorNotificationProps) => {
        ...
        <div className="mx-auto bg-red-50 border-l-4 border-red-500 p-4 rounded shadow-md w-[50%]  z-20">
            <div className="flex z-20">
                <div className="flex-shrink-0">
                    <svg onClick={() => setVisible(false)} className="h-5 w-5 text-red-400 cursor-pointer" viewBox="0 0 20 20" fill="currentColor">

...
export default function Drawer() {
    ...
    return <div className={isOpen ? "flex flex-row w-fit md:w-full h-fit border-black  bg-backgroundColor border-2 items-center fixed md:static z-50" : "flex flex-row w-full h-fit items-center md:static z-50"}>
